...
void stock_plant(bool A1, bool A2, bool A3){
    ...
    angle_AX12(ID_BIELLE,POS_BIELLE_PUSH,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_PUSH,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_PUSH,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_PULL,VIT_AX,SANS_ATTENTE); // on monte le rack      angle_AX12(ID_BIELLE,260,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_PULL,VIT_AX,SANS_ATTENTE); // on monte le rack      angle_AX12(ID_BIELLE,260,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_PULL,VIT_AX,SANS_ATTENTE); // on monte le rack 
    ...
    angle_AX12(ID_BIELLE,POS_BIELLE_DOWN,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_DOWN,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_DOWN,VIT_AX,SANS_ATTENTE); // on monte le rack      angle_AX12(ID_BIELLE,260,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_DOWN,VIT_AX,SANS_ATTENTE); // on monte le rack      angle_AX12(ID_BIELLE,260,VIT_AX,SANS_ATTENTE); // on monte le rack 
    angle_AX12(ID_BIELLE,POS_BIELLE_DOWN,VIT_AX,SANS_ATTENTE); // on monte le rack 
